function hideColumnFull(tableId){
...
function conditionalFormattingFull(row, data, stockcode_favorite){
...
function renderTableFull(tableId, response){
    ...
    $('#'+tableId).dataTable( {
        ...
        columnDefs: [
                ...
                // RANK
                { width: 30, targets: [34, 35, 36, 37] },

                // EVENT PATTERN
                { width: 90, targets: 38 },

                // DAYS EVENT
                { width: 30, targets: [39,40,41,42] , render: $.fn.dataTable.render.number(',', '.', 0, '')},

                // BBP EVENT
                { width: 30, targets: [43,44,45,46] , render: $.fn.dataTable.render.number(',', '.', 2, '')},

                // BBW EVENT
                { width: 30, targets: [47,48,49,50] , render: $.fn.dataTable.render.number(',', '.', 2, '')},

                // FINAN
                { width: 30, targets: [51,52,53] , render: $.fn.dataTable.render.number(',', '.', 2, '')},

                // CATEGORY
                { width: 200, targets: [54] },
